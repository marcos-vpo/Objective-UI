...
//exports.UILabelBinder = //exports.UIImage = //exports.UIImageBinder = //exports.UICheckBoxBS5 = //exports.UICheckBox = //exports.UICheckBoxBinder = //exports.UIButton = //exports.UIRadioOptionBS5 = //exports.RadioOption = //exports.UIRadioGroup = //exports.UIRadioGroupBinder = //exports.ModalAction = //exports.UIHead = //exports.UIHeadBinder = //exports.DefaultExceptionPage = //exports.jQuery = //exports.VirtualFunction = //exports.WidgetMessage = //exports.WidgetFragment = //exports.ViewLayout = //exports.ViewDictionaryEntry = //exports.SelectOption = //exports.RhabooStorageWrapper = //exports.RhabooInstance = //exports.AppStorage = //exports.Misc = //exports.Row = //exports.RowOptions = //exports.PageShell = //exports.NativeLib = //exports.DefaultLayoutPresenter = //exports.Col = //exports.ColOptions = //exports.WebAPISimulator = //exports.SimulatedAPIRoute = //exports.WebAPI = //exports.APIResponse = //exports.Bearer = //exports.WidgetBinder = //exports.WidgetBinderBehavior = //exports.BindingContext = //exports.WidgetContext = //exports.Widget = //exports.ViewCache = //exports.ViewBuilder = //exports.UIFlatView = //exports.FlatListItem = //exports.FlatList = //exports.UIView = //exports.UIPage = void 0;
//exports.HtmlLayout = //exports.YordViewContext = //exports.YordView = //exports.YordManagedView = //exports.DivContent = //exports.UIDataGrid = //exports.UIDataGridBinder = //exports.DataGridColumnDefinition = //exports.UITemplateView = //exports.ListItem = //exports.UIToolBar = //exports.ToolbarState = //exports.DataGridItem = //exports.UIToast = //exports.UITextArea = //exports.UITextAreaBinder = //exports.UITextBox = //exports.UITextBoxBinder = //exports.Mask = //exports.UISwitcher = //exports.UISpinner = //exports.UISelect = //exports.UISelectBinder = //exports.UIProgressBar = //exports.UINavBar = //exports.UIDialogBS5 = //exports.UIDialog = //exports.UIList = //exports.UIListBinder = //exports.UILabel = void 0;
/**
...
UIPage.PRODUCT_VERSION = '1.0.16';
UIPage.DISABLE_EXCEPTION_PAGE = false;
UIPage.DEBUG_MODE = false;
/**
...
class FlatList {
    ...
    getListItemTemplate(sender, viewModel) {
        if (Misc.isNull(viewModel))
            return;
...
class FlatListItem {
    ...
    isSelected() {
        if (Misc.isNull(this.fn_isSelected))
            return false;
    ...
    itemTemplate() {
        ...
        if (!Misc.isNull(this.fn_itemTemplateString)) {
            ...
            var anchor = templ.elementById('anchor');
...
class UIFlatView extends UIView {
    static findCached(path) {
    ...
    static load(view) {
        ...
        if (!Misc.isNull(cached)) {
            ...
            ViewLayout.load(view.builder.layoutPath, function (html) {
    ...
    composeView() {
        for (var c = 0; c < this.builder.viewContent.length; c++) {
            var content = this.builder.viewContent[c];
    ...
    getViewModel(callValidations = true) {
        return this.binding.getViewModel(callValidations);
    }
    setViewModel(instance, updateUI = true) {
...
class ViewBuilder {
    ...
    validate(propertyName, validateFn) {
    ...
    put(divId, ...w) {
        this.viewContent.push(new DivContent(divId, ...w));
        return this;
    }
    onLoad(fn) {
        this.onLoadFn = fn;
...
class BindingContext {
     ...
     * @param validateFn
     ...
     ```
     */
    hasValidation(modelPropertyName, validateFn) {
     ...
     * @returns
     */
    setViewModel(viewModelInstance, updateUI = true) {
...
class DefaultLayoutPresenter {
    ...
    renderLayout(layout, pageShell) {
        ...
        for (let rowIndex = 0; rowIndex < layout.layoutRows.length; rowIndex++) {
            ...
            var rowDivEl = this.renderRow(rowObj);
            if (UIPage.DEBUG_MODE)
                rowDivEl.append(`
                Row: ${rowDivEl.id}
            `);
...
class PageShell {
     ...
     */
    requestSplitView(splittedCallingView) {
...
```
     * @returns
     */
    fromHTML(rawHtmlLayoutString, staticData) {
   ...
   * ```
   */
    static load(layoutUri, intoCallBack) {
...
class RadioOption {
    constructor(text, value, fieldSetId, shell, ownerGroup, customTemplate) {
        ...
        var template = new UITemplateView(Misc.isNullOrEmpty(customTemplate)
            ? `
 ...
 */
class UIRadioOptionBS5 extends RadioOption {
...
//exports.UIRadioOptionBS5 = UIRadioOptionBS5;
 ...
 */
class UICheckBoxBS5 extends UICheckBox {
...
//exports.UICheckBoxBS5 = UICheckBoxBS5;
...
<div id="fsListView" class="list-group">
    ...
    setOnItemClick(itemClicked) {
        this.itemClickedCallback = itemClicked;
    }
}
//exports.UIList = UIList;
class UIDialog extends Widget {
    constructor(shell, customTempl) {
        super('UIDialog');
        this.modalActions = [];
        this.customTemplate = null;
        this.dataDismissAttrName = 'data-dismiss';
    ...
    setDataDismisAttributeName(attrName) {
...
class UIDialogBS5 extends UIDialog {
    constructor(shell, height = '60vh') {
        const tmpl = `
...
//exports.UIDialogBS5 = UIDialogBS5;
...
class UITextBox extends Widget {
    constructor({ name, type = 'text', title = '', maxlength = 100, placeHolder = '', text = '', mask = '', containerClass = 'form-group', isRequired = false }) {
        super(name);
        this.initialTitle = null;
...
<div id="divContainer" class="${this.containerClass}">
    ...
    value() {
        if (this.txInput.type == 'text')
            return this.txInput.value.toString();
        if (this.txInput.type == 'number') {
            if (this.isFloat)
                return Number.parseFloat(this.txInput.value);
            else
                return Number.parseInt(this.txInput.value);
        }
...
class ToolbarState {
    constructor(name, callback, ...buttons) {
        this.name = name;
...
class UIToolBar extends Widget {
    ...
    defineState(name, callback, ...buttons) {
    ...
    activateState(stateName) {
        ...
        const $ = this;
        this.optionsContext.build(new class Noty {
            onNotified(sender, args) {
...
<div class="d-flex flex-row card shadow-sm mx-2 p-0 mt-2" style="height:52px; background:whitesmoke">
    ...
    onWidgetDidLoad() {
        const iconeEl = this.elementById('ic_rotina');
        const tituloEl = this.elementById('lb_titulo');
        const dvOpcoes = this.elementById('dv_opcoes');
    ...
    getOption(buttonName) {
        return this.optionsContext.get(`${this.containerId}/${buttonName}`);
    }
}
...
class UITemplateView {
     ...
     * @param data
     */
    constructor(htmlContent, shell, data) {
...
class UIDataGrid extends Widget {
    constructor({ name, autoGenCols = false, baseTemplate = null, cssClasses = null }) {
        ...
        this.tableCssClasses = 'table table-hover table-bordered table-sm';
