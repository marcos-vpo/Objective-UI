...
export abstract class WidgetBinder
{
    ...
    {
        if ( this.ownerCtx.getViewModelInstance() == null || this.modelPropertyName == null || this.modelPropertyName == '')
            return null;
        var value =  this.ownerCtx.getViewModelInstance()[this.modelPropertyName];
        return value;
    }
    ...
    setModelPropertyValue(value: any | object): void
    {
       ...
       this.ownerCtx.getViewModelInstance()[this.modelPropertyName] = value;
    }
    ...
    fillModelTargetPropertyValue(): void
    {
        ...
        this.ownerCtx.getViewModelInstance()[this.modelTargetProperty] = value;
    }
    ...
    {
        if (this.isTargetDefined() == false) return;
        var value = this.ownerCtx.getViewModelInstance()[this.modelTargetProperty];
        return value;
    }

    private ownerCtx: BindingContext<any>
    setModel(ctx: BindingContext<any>, propertyName: string): void
    {
        this.ownerCtx = ctx;
    ...
    {
        return this.ownerCtx.getViewModelInstance() as TModel
    }
}